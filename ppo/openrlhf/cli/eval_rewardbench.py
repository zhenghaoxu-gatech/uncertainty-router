...
def save_intermediate_results(save_path, total_diffs, category_correct, category_total, subset_correct, subset_total):
    """
...
def plot_from_saved_results(results_dir: str):
    ...
    try:
        ...
        total_diffs, statistics = load_intermediate_results(results_dir)
...
def evaluate_on_rewardbench(
    ...
    if local_rank == 0 or local_rank == -1:
        ...
        ece = plot_score_distributions(
            total_diffs,
            uncertainties=np.array(total_uncertainties),
