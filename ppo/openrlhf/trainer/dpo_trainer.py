...
from openrlhf.models import DPOLoss, CenteredDPOLoss
...
class DPOTrainer(ABC):
    ...
    def __init__(
        ...
        self.beta = beta
        if self.args.loss == "centered":
            self.loss_fn = CenteredDPOLoss(self.beta, self.args.label_smoothing, self.args.ipo, self.args.center_coef)
        else:
